...
if (isMobile) {
  return (
    <>
      {/* Persistent icon rail, mirrors desktop collapsed look */}
      <div
        className="group peer hidden text-sidebar-foreground data-[collapsible=icon]:block"
        data-state={state}
      ...
      >
        <div
          ...
          data-side={side}
          className="fixed inset-y-0 left-0 z-10 flex h-svh w-(--sidebar-width-icon) flex-col border-r border-sidebar-border bg-sidebar"
        >
          <div
            data-sidebar="sidebar"
            data-slot="sidebar-inner"
            className="flex size-full flex-col bg-sidebar group-data-[collapsible=icon]:overflow-hidden"
          >
            {children}
          </div>
        </div>
      ...
      {/* Full-screen sheet when expanded */}
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          dir={dir}
          data-sidebar="sidebar"
