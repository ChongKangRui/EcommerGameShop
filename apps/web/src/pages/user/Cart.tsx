...
export default function Cart() {
  ...
  const cartValidate = useCartValidate();
  ...
  const onCheckout = () => {
    ...
    cartValidate.mutate(undefined, {
      ...
      onError: () => {
        flashMessage_Failed("Unable to validate cart, please try again");
      },
    });
  };
      ...
      {items.length !== 0 && (
        <div>
          ...
          <div className="grid grid-cols-8 mb-10">
            ...
            <h1 className="hidden md:block md:col-span-3 lg:col-span-2">
              Quantity
            </h1>
              ...
              return (
                <div key={i.variation_id}>
                  <CartProduct
                    ...
                    price={i.final_price}
                    disabled={cartValidate.isPending}
                    quantity={i.quantity}
                    maxQuantity={i.stock}
                    productName={i.name}
                    label={i.label}
          ...
          <div className="text-center md:text-end md:w-8/10">
            ...
            <Button
              ...
              disabled={cartValidate.isPending}
              onClick={() =>
                isAuthenticated ? onCheckout() : registerRequire()
              }
            >
              Checkout
            </Button>
